...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 20 Avril 2017 à 19:20
...
CREATE TABLE `challenge` (
  ...
  `uriMap` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL
...
(1, 2017, 'bla bla', 'bla bla', 'Le Programme           Cette année Totem Challenge aura lieu le 22 septembre 2017           Départ des équipage à 09H00           Fin du challenge à 18H00', '#hastag', '2017-04-21 09:00:00', '2017-06-19 18:00:00', 'inactive', '', NULL, '');
...
(1, 'test1', 'test1', '', 'test1', 'sega1_l.png', '2017-04-18 09:01:18'),
(2, 'test2', 'Un jolie texte pour un test.', 'Un jolie texte pour un test.', 'www.google.fr', NULL, '2017-04-19 01:02:47'),
(3, 'Totem2', 'gtrver', 'ezftrgtr', 'rgtrgre', '', '2017-04-19 01:24:51'),
(4, 'Totem2', 'gtrver', 'ezftrgtr', 'rgtrgre', '', '2017-04-19 01:26:15'),
(5, 'Test creation 2', 'sgtgrg', 'rsgtrg', 'rgtrgre', '', '2017-04-19 01:27:22');
...
(37, 'administrateur', 'administrateur', 'admin', '0011223355', 'administrateur@totem.fr', '$2y$10$CsGLQLu80beq2GLSC6tpduPDgf06t7/JTixgua2qLdrj3gd45aPRO', '2017-04-15 03:10:28', '2017-04-20 05:39:50', 'valider', '0y_XE-h5OdgroeZMTVi-7aVsOfHiv9fp', NULL, 'administrateur@totem.fr', 1);
...
(5, 37, '', '', 'logoavatar-id-37.png', '', '', 'logoavatar-id-37.png');
...
(1, 'Challenge Totem 2017', 'www.webfor3.com', '9 impasse des gymnastes', '13012', 'Marseille', '0011223344', 'logo.gif', 'gogol', 'chrastophe@gmail.com', 'https://www.facebook.com/christophe.bautista.7', 'https://twitter.com/crizzouille', 'https://twitter.com/crizzouille');
